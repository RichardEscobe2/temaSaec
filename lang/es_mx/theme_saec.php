...
// "Estudiantes y Progreso" (/grade/report/user/index.php, docente — Fase 20).
$string['teacherprogresstitle'] = 'Estudiantes y Progreso';
$string['teacherprogresscourseselector'] = 'Seleccionar curso';
$string['teacherprogresskpienrolled'] = 'Alumnos Inscritos';
$string['teacherprogresskpiavggrade'] = 'Promedio del Curso';
$string['teacherprogresskpisubmissionrate'] = 'Tasa de Entregas';
$string['teacherprogresskpiattendance'] = 'Asistencia Promedio';
$string['teacherprogressattendanceunavailable'] = 'No disponible';
$string['teacherprogressatriskheading'] = 'Alumnos en Riesgo';
$string['teacherprogressgradeabbrev'] = 'Prom.';
$string['teacherprogressattendanceabbrev'] = 'Asist.';
$string['teacherprogressrosterheading'] = 'Listado de Alumnos';
$string['teacherprogresscolstudent'] = 'Alumno';
$string['teacherprogresscolprogress'] = 'Progreso';
$string['teacherprogresscolgrade'] = 'Calificación';
$string['teacherprogresscolattendance'] = 'Asistencia';
$string['teacherprogresscolstatus'] = 'Estatus';
$string['teacherprogresscolactions'] = 'Acciones';
$string['teacherprogressviewreport'] = 'Ver Boleta';
$string['teacherprogressnostudents'] = 'Este curso aún no tiene alumnos inscritos.';
$string['teacherprogressstatusacreditado'] = 'Acreditado';
$string['teacherprogressstatusregular'] = 'Regular';
$string['teacherprogressstatusenriesgo'] = 'En Riesgo';

// "Reportes y Auditoría" (/report/log/index.php, admin — Fase 20).
$string['adminreportstitle'] = 'Reportes y Auditoría';
$string['adminreportssubtitle'] = 'Actividad y salud del sistema en tiempo real.';
$string['adminreportsexportcsv'] = 'Exportar CSV';
$string['adminreportsexportexcel'] = 'Exportar Excel';
$string['adminreportskpiactiveusers'] = 'Usuarios Activos (7 días)';
$string['adminreportskpiglobalaverage'] = 'Promedio Institucional';
$string['adminreportskpibadges'] = 'Insignias Emitidas';
$string['adminreportskpitodayevents'] = 'Eventos de Hoy';
$string['adminreportstrendheading'] = 'Tendencia de Actividad (7 días)';
$string['adminreportsnotrend'] = 'Aún no hay actividad registrada en este periodo.';
$string['adminreportsauditheading'] = 'Bitácora de Auditoría Reciente';
$string['adminreportscoltimestamp'] = 'Fecha y Hora';
$string['adminreportscoluser'] = 'Usuario';
$string['adminreportscoluseremail'] = 'Correo Electrónico';
$string['adminreportscolevent'] = 'Evento';
$string['adminreportscolcomponentaction'] = 'Componente / Acción';
$string['adminreportscolip'] = 'Dirección IP';
$string['adminreportscolcontext'] = 'Contexto';
$string['adminreportsnoaudit'] = 'Aún no hay eventos registrados.';
$string['adminreportsactoranonymous'] = 'Anónimo';
$string['adminreportsactorsystem'] = 'Sistema';
